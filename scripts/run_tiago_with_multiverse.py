...
if __name__ == "__main__":
    scene_path = os.path.join(
        os.path.dirname(__file__), "..", "assets", "apartment_with_tiago.xml"
    )
    ...
    multiverse_params = {
        ...
        "receive": {
            ...
            "arm_position_1_position": ["cmd_joint_angular_position"],
            "arm_position_2_position": ["cmd_joint_angular_position"],
            "arm_position_3_position": ["cmd_joint_angular_position"],
            "arm_position_4_position": ["cmd_joint_angular_position"],
            "arm_position_5_position": ["cmd_joint_angular_position"],
            "arm_position_6_position": ["cmd_joint_angular_position"],
            "arm_position_7_position": ["cmd_joint_angular_position"],
