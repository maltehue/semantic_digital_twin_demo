...
if __name__ == "__main__":
    ...
    multiverse_params = {
        ...
        "receive": {
            ...
            "arm_left_1_joint_position": ["cmd_joint_angular_position"],
            "arm_left_2_joint_position": ["cmd_joint_angular_position"],
            "arm_left_3_joint_position": ["cmd_joint_angular_position"],
            "arm_left_4_joint_position": ["cmd_joint_angular_position"],
            "arm_left_5_joint_position": ["cmd_joint_angular_position"],
            "arm_left_6_joint_position": ["cmd_joint_angular_position"],
            "arm_left_7_joint_position": ["cmd_joint_angular_position"],
            "arm_right_1_joint_position": ["cmd_joint_angular_position"],
            "arm_right_2_joint_position": ["cmd_joint_angular_position"],
            "arm_right_3_joint_position": ["cmd_joint_angular_position"],
            "arm_right_4_joint_position": ["cmd_joint_angular_position"],
            "arm_right_5_joint_position": ["cmd_joint_angular_position"],
            "arm_right_6_joint_position": ["cmd_joint_angular_position"],
            "arm_right_7_joint_position": ["cmd_joint_angular_position"],
